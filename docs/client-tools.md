...
```bash
pnpm add @inupedia/spotlight-client@0.8.1 @inupedia/spotlight-protocol@0.8.1 @inupedia/spotlight-vue@0.8.1
```
...
1. 将使用到的 `@inupedia/spotlight-*` 包统一升级到 `0.8.1`，不要混装 `link:`、本地构建和 Registry 包。
